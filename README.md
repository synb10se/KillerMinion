...
- **Offener ABRP API Key:** Der im Code enthaltene ABRP-API-Key (`7310445a-...`) ist der von ABRP offiziell für dieses Leapmotor-Projekt registrierte Developer-Key. Er enthält keine persönlichen Daten, sondern identifiziert das Skript gegenüber den ABRP-Servern als berechtigte Integration. Deine persönlichen Telemetrie-Daten werden ausschließlich über den eigenen User-Token zugeordnet.
