...
- **Offener ABRP API Key:** Der im Code enthaltene ABRP-API-Key (`7310445a-...`) ist der offizielle "Public Open-Source" Key von Iternio/ABRP, der z. B. auch in der Home Assistant Integration genutzt wird. Er enthält keine privaten Daten und identifiziert das Skript lediglich als freie Telemetrie-Integration gegenüber den ABRP-Servern.
